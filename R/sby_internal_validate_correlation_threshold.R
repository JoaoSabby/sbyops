#' @title Internal Helper: Validate Correlation Threshold
#'
#' @usage sby_internal_validate_correlation_threshold(...)
#'
...
sby_internal_validate_correlation_threshold <- function(threshold){

  sby_internal_validate_threshold_scalar(threshold = threshold, arg_name = "threshold")
}
####
## End
# 
